function optout = ApproxMPCctrlVHDLset(fun,opts)
% ApproxMPCctrlVHDLset   Checks and sets the options for the generation of VHDL code for
%          the ApproxMPCctrlVHDLset object
%
