...
fin = fopen([getvhdlpath(),'discontinuousPwasFunction/discontinuousPwasFunction.vhd'],'r');
fout = fopen([folder,'discontinuousPwasFunction.vhd'],'w');
count_matlabgen = 1;
...
while 1
    ...
    if strcmp(tline,'--- BEGIN MATLABGEN ---')
        ...
        if count_matlabgen == 1
            ...
            fprintf(fout,'entity discontinuousPwasFunction is\n');
            ...
            fprintf(fout,'end discontinuousPwasFunction;\n');
...
disp(['Generated file ',folder,'discontinuousPwasFunction.vhd']);
