function optout = embeddedSystemCset(fun,opts)
...
if ~isfield(opts,'initialState') || isempty(opts.initialState)
    optout.initialState = zeros(fun.nx+fun.nd,1);
else
...
if isa(fun.getController, 'implicitMPCctrl') 
