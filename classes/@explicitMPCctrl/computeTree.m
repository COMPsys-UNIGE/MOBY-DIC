...
%
% OBJ = computeTree(OBJ)
% Computes the binary search tree with the default settings (see below).
% The binary search tree represents the polytopic domain partition and it 
% is explored in order to solve efficiently the point location problem 
% (i.e., finding the polytope a given point belongs to). The tree is used 
% by the circuit implemented on FPGA. OBJ is the explicitMPCctrl object.
%
...
%
% See also: explicitMPCctrl/plotTree.
