...
%
% plot(OBJ)
% Plots the MPC control function at current time step. OBJ is the explicitMPCctrl
% object.
%
% plot(OBJ,IDX)
% Plots the MPC control function at time step IDX.
%
...
if any(k < 1) || any(k > object.nu*object.nfun)
    error(['IDX must be an integer number between 1 and ',num2str(object.nfun)]);
end
