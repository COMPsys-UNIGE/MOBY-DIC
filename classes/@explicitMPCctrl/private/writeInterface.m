...
% writeInterface   Writes the VHDL code implementing block controllerInterface
%
% writeInterface(OBJ,OPTS)
...
fin = fopen([getvhdlpath(),'explicitMPCctrl/controllerInterface.vhd'],'r');
