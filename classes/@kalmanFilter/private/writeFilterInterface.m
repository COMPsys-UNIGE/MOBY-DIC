...
fin = fopen([getvhdlpath(),'kalmanFilter/kalmanFilterInterface.vhdl'],'r');
fout = fopen([folder,'kalmanFilterInterface.vhdl'],'w');
...
disp(['Generated file ',folder,'kalmanFilterInterface.vhdl']);
