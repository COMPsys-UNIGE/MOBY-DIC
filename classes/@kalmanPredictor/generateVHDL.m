...
[FintPred, GintPred, alphaPred, betaPred, nint, nint_coeffPred] = quantizeData([Ascale Bscale],Gxscale,bound,nbit,nbit_coeff);
...
% copy other file
% copyfile([getvhdlpath,'/kalmanPredictor/shifterMACPredictor.vhdl'],[folder,'/shifterMACPredictor.vhdl']);
% copyfile([getvhdlpath,'/kalmanPredictor/statePredict.vhdl'],[folder,'/statePredict.vhdl']);
% copyfile([getvhdlpath,'/kalmanPredictor/kalmanPredictor.vhdl'],[folder,'/kalmanPredictor.vhdl']);
copyfile([getvhdlpath,'kalmanPredictor/shifterMACPredictor.vhdl'],[folder,'shifterMACPredictor.vhdl']);
copyfile([getvhdlpath,'kalmanPredictor/statePredict.vhdl'],[folder,'statePredict.vhdl']);
copyfile([getvhdlpath,'kalmanPredictor/kalmanPredictor.vhdl'],[folder,'kalmanPredictor.vhdl']);
...
if generateInterface
    ...
    copyfile([getvhdlpath,'/kalmanPredictor/mulBank.vhdl'],[folder,'/mulBank.vhdl']);
