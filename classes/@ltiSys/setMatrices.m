function object = setMatrices(object,varargin)
% setMatrices    Sets the matrices defining the LTI system
%
% OBJ = setMatrices(OBJ,NAME,MATR)
% NAME is a string identifying which matrix you want to set to the LTI 
% system OBJ. NAME can be  either 'A', 'B', 'C', 'D', 'Ex', 'Ey', 'Fx', 
% 'Fy', 'Gx' or 'Gy'. MATR is the matrix to set.
