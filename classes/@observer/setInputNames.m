...
% setInputNames   Gives a mnemonical name to the input variables
%
% OBJ = setInputNames(OBJ,INPUTNAMES)
% INPUTNAMES must be a cell array whose elements are strings representing
% the name of the corresponding input. OBJ is the observer object.
%
% See also observer/setParameterNames, observer/setStateNames, 
