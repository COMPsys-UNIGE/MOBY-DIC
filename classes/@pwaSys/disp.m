...
% disp    Displays some information about the pwaSys object
%
% disp(OBJ)
...
if object.nx == 0
    disp('Empty pwaSys object');
else
    if strcmp(object.mode,'ct')
        disp('Piecewise-affine continuous-time system with: ')
        disp([' - ',num2str(object.nDyn),' dynamic(s)']);
...
%         disp(' ')
        ...
        disp('Piecewise-affine discrete-time system with: ')
        disp([' - ',num2str(object.nx),' state variables']);
        disp([' - ',num2str(object.nu),' input variables']);
        disp([' - ',num2str(object.ny),' output variables']);
        disp([' - ',num2str(object.np),' parameters']);
