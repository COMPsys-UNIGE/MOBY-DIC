function ct_simulinkOpenLoopSim(object,options)
% ct_simulinkOpenLoopSim    Generates a Simulink model for the 
...
if strcmpi(choice,'Overwrite')
    ...
    copyfile([options.simulinkFolder,'ct/',model],[options.folder,'pwaSys_model.mdl']);
