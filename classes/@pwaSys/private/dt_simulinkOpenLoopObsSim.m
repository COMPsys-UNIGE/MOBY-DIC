function dt_simulinkOpenLoopObsSim(object,options)
% dt_simulinkOpenLoopObsSim    Generates a Simulink model for the 
...
if strcmpi(choice,'Overwrite')
    ...
    save([options.folder,'simulink.mat'],'sim_A','sim_B','sim_C','sim_D','sim_Ts',...
        ...
        save([options.folder,'simulink.mat'],'sim_A','sim_B','sim_C','sim_D', 'sim_H','sim_K',...
            'sim_nx','sim_ny','sim_np','sim_nd','sim_u_scale_gain','sim_u_scale_bias','sim_Ts',...
