...
%                         repmat(signals.unmeasurable_input',npts,1)]*Hright')./...
                    ...
                    if ~isempty(Krightp)
                        if nxref ~= 0
                            up = (repmat(Krightp',npts,1)-...
                                ...
                                signals.output...
                                repmat(signals.ref',npts,1)]*Hrightp')./...
                    ...
                    if ~isempty(Krightn)
                        if nxref ~= 0
                            down = (repmat(Krightn',npts,1)-...
                                ...
                                repmat(signals.unmeasurable_input',npts,1)...
                                signals.output...
                                repmat(signals.ref',npts,1)]*Hrightn')./...
                    ...
                    if ~isempty(Ksrightp)
                        if nxref ~= 0
                            up = (repmat(Ksrightp',npts,1)-...
                                ...
                                repmat(signals.unmeasurable_input,npts,1)...
                                signals.output...
                                repmat(signals.ref,npts,1)]*Hsrightp')./...
                    ...
                    if ~isempty(Ksrightn)
                        if nxref ~= 0
                            down = (repmat(Ksrightn',npts,1)-...
                                ...
                                repmat(signals.unmeasurable_input,npts,1)...
                                signals.output...
                                repmat(signals.ref,npts,1)]*Hsrightn')./...
