function writePackage(object,outputRepresentation,nbit,nbit_coeff,nbitout,sampling_latency,defaultOutput,folder)
% writePackage
...
nDyn = object.nDyn;
% Open files
fin = fopen([getvhdlpath(),'switchedApproxMPCctrl/controller_package.vhd'],'r');
...
while 1
    ...
    if strcmp(tline,'--- BEGIN MATLABGEN ---')
        ...
        fprintf(fout,'\t-- Number of dynamics\n');
        fprintf(fout,'\tconstant N_DYN_CTRL : integer := %d;\n',nDyn);
        ...
        fprintf(fout,'\ttype mul_in_matrix_CTRL is array(N_DIM_CTRL downto 0) of signed(N_BIT_MUL_CTRL-1 downto 0);\n');
        fprintf(fout,'\ttype mul_out_matrix_CTRL is array(N_DIM_CTRL downto 0) of signed(2*N_BIT_MUL_CTRL-1 downto 0);\n');
