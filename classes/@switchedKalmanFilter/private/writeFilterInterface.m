function writeFilterInterface(object,folder)
...
fin = fopen([getvhdlpath(),'switchedKalmanFilter/switchedKalmanFilterInterface.vhdl'],'r');
fout = fopen([folder,'switchedKalmanFilterInterface.vhdl'],'w');
...
disp(['Generated file ',folder,'switchedKalmanFilterInterface.vhdl']);
