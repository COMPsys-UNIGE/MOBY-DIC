...
%
% [A B C D Gx Gy] = getMatrices(OBJ)
% Gets matrices A, B, C, D, Gx and Gy defining the Kalman predictor 
% discrete-time dynamical system. OBJ is the kalmanPredictor object.
%
...
for i=1:nDyn
    [A{i}, B{i}, C{i}, D{i}, Gx{i}, Gy{i}] = object.filters(i).kPredictor.getMatrices;
