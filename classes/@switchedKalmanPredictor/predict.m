function xpred = predict(object,xcur,ucur,pcur,ycur)
% predict   Predicts the system state at next time instant based on current
%           measurements
%
% XPRED = predict(OBJ,XCUR,UCUR,PCUR,YCUR)
...
% XPRED is the predicted state for next time instant. 
...
% Boston, MA  02111-1307  USA
    ...
    ii = object.findDynamics(xcur,pcur);
    
    xpred = object.filters(ii).kPredictor.predict(xcur,ucur,pcur,ycur);
