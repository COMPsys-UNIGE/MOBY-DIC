...
fin = fopen([getvhdlpath(),'switchedKalmanPredictor/switchedKalmanPredictorInterface.vhdl'],'r');
fout = fopen([folder,'switchedKalmanPredictorInterface.vhdl'],'w');
...
disp(['Generated file ',folder,'switchedKalmanPredictorInterface.vhdl']);
