...
% disp   Displays some information about the switchedMPCctrl object
%
% disp(OBJ)

% OBJ is the switchedMPCctrl object.
...
if object.nu == 0
    disp('Empty switchedMPC controller object');
else
    disp('Explicit switchedMPC controller for a system with: ')
