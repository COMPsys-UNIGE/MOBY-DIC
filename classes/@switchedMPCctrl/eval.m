% eval   Evaluates the MPC control function that have to be applied  
%         for the specific dynamic
%
% U = eval(OBJ,X)
...
% as the number of rows of X. If REF has only one row, the same value is
% used for all points.
%
% U = eval(OBJ,X,P,D)
% Evaluates the control function at the system states specified by matrix 
