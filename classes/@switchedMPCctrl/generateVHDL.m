...
circuit_parameters = object.switchedMPCctrlVHDLset(circuit_parameters);
...
%generate main block
copyfile([getvhdlpath,'/switchedMPCctrl/switchedControllerCircuit.vhd'],[folder,'/switchedControllerCircuit.vhd']);
...
if generateInterface
    ...
    copyfile([getvhdlpath,'/switchedMPCctrl/mulBank.vhd'],[folder,'/mulBank.vhd']);
