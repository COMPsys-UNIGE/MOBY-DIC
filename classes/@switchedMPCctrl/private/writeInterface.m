...
fin = fopen([getvhdlpath(),'switchedMPCctrl/switchedControllerInterface.vhd'],'r');
fout = fopen([folder,'switchedControllerInterface.vhd'],'w');
count_matlabgen = 1;
...
while 1
    ...
    if strcmp(tline,'--- BEGIN MATLABGEN ---')
        ...
        if count_matlabgen == 1
            ...
            fprintf(fout,'entity switchedControllerInterface is\n');
            ...
            fprintf(fout,'end switchedControllerInterface;\n');
